...
- Nadi Account Vault Blueprint with Account Vault Limits, Support Repair Joins, and a Backend Storage Handoff Board that converts browser-local research into plan-capped backend-owned row contracts with migration batch, support-safe repair receipts, handoff receipt, restore proof, export/delete proof, deletion receipt, support redaction, and rollback boundaries.
