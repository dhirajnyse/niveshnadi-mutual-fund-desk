...
This Phase 1 v311 prototype is a compact static web app with no build step. Open `index.html` directly or publish the repository through GitHub Pages.
...
- Nadi Retail Account Launch Route with Support Operations Handoff, Founder Auth Decision Board, Founder Storage Decision Board, Founder Beta Checklist, Founder Invite Gate, Founder Invite Receipt, Founder Support Drill, Founder Support Casebook, Account Recovery and Retention Receipts, Lifecycle Worker Acceptance Tickets, Account Lifecycle Worker Smoke Harness, Account Lifecycle Production Owner Gates, Account Lifecycle Deploy Runbook Packet, and Account Lifecycle Rollout Approval Archive that turn auth choice, recovery, session retention, account storage, saved research migration, vault restore, deletion closeout, paid entitlement join, export/delete, support notices, support redaction, monitoring, first-case receipts, support receipts, pause rules, retention windows, worker endpoints, payload contracts, queues, logs, monitor events, closeout tests, CI smoke fixtures, command refs, artifact URIs, assertion checks, owner pass/fail gates, deploy command refs, command receipts, environment checks, rollback contacts, incident rollback posture, release notes, support closeout, staged rollout approvals, live monitor windows, release captain signoff, support readiness, rollback approvals, post-deploy evidence archive, final production no-go rules, and the Phase 2 firewall into one invite-ready beta route.
