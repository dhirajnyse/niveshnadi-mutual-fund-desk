...
This Phase 1 v166 prototype is a compact static web app with no build step. Open `index.html` directly or publish the repository through GitHub Pages.
...
- Nadi Market Strategy Room that keeps B2C pricing, competitor posture, monetization scenarios, trust moats, paid beta gates, and the Phase 2 distributor boundary visible inside the founder workspace.
...
- Nadi Research Autopilot with Autopilot Mission Plan on the first screen that converts Signal, Genome, Future Shock, Memory Replay, Evidence, Compare, and Memo gates into one next-best research command, route-memory plan, no-go rule, and copyable workflow brief.
