...
- Nadi Retail Account Launch Route with Support Operations Handoff, Founder Auth Decision Board, Founder Storage Decision Board, Founder Beta Checklist, Founder Invite Gate, Founder Invite Receipt, Founder Support Drill, and Founder Support Casebook that turn auth choice, recovery, session policy, account storage, saved research migration, paid entitlement join, export/delete, support redaction, monitoring, first-case receipts, support receipts, pause rules, and the Phase 2 firewall into one invite-ready beta route.
