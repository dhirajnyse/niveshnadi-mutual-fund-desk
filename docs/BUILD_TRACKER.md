...
- Verification status: Syntax, static/security, marker, and diff hygiene checks passed; v647-v651 desktop/mobile and live verification are the remaining batch closeout gates.
