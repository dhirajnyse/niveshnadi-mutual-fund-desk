...
The Phase 1 paid tier may charge for software convenience, research history, alerting, exports, and workflow organization. It should not charge for personalized recommendations unless the regulatory posture changes. Pricing copy should remain transparent and should not suggest that NiveshNadi is compensated by AMCs or distributors in Phase 1.
