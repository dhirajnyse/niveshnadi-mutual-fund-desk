...
V112 adds the Gateway and Retention Policy board. It binds provider choice, invoice and refund posture, entitlement repair, settlement reconciliation, retention windows, export/delete interaction, and support ownership into one payment-policy receipt before paid beta.
