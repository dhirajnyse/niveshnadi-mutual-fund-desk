...
assert(app.includes("supportRepairCloseoutReceipt") && app.includes("data-copy-support-repair-closeout-receipt"), "app.js is missing v543 Support Repair Closeout Receipt.");
