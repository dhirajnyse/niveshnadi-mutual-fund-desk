...
assert(app.includes('value: "Static pass"') && app.includes('value: "Batch visual pending"') && app.includes('value: "Batch push pending"') && app.includes('value: "Local checks passed"'), "app.js is missing the v655 local release receipt.");
