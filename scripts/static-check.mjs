...
assert(app.includes("paymentReconciliationDrill") && app.includes("data-copy-payment-reconciliation-drill"), "app.js is missing v525 Payment Reconciliation Drill.");
