...
assert(app.includes("paymentIncidentReplayRehearsal") && app.includes("data-copy-payment-incident-replay-rehearsal"), "app.js is missing v545 Payment Incident Replay Rehearsal.");
