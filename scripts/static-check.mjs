...
assert(app.includes("accountCustodyRetentionRegister") && app.includes("data-copy-account-custody-retention-register"), "app.js is missing v531 Account Custody Retention Register.");
