...
assert(app.includes("accountRecoveryPolicyCopyRoom") && app.includes("data-copy-account-recovery-policy-copy-room"), "app.js is missing v521 Account Recovery Policy Copy Room.");
