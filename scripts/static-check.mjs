...
assert(app.includes('value: "Static + visual pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Push pending"') && app.includes('value: "Local + visual passed"'), "app.js is missing the v641 local visual release receipt.");
assert(app.includes('{ version: "v636", key: "20260719-v636-01", commit: "534f49b"') && !app.includes('{ version: "v631", key: "20260717-v631-01", commit: "625355a"'), "app.js release proof archive did not roll forward to v636-v632.");
