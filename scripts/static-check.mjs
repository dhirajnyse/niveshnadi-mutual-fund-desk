...
assert(app.includes('value: "Static pass"') && app.includes('value: "Batch visual pending"') && app.includes('value: "Push pending"'), "app.js is missing the v637 local release receipt.");
