...
assert(app.includes("accountCustodyExpiryRehearsal") && app.includes("data-copy-account-custody-expiry-rehearsal"), "app.js is missing v541 Account Custody Expiry Rehearsal.");
