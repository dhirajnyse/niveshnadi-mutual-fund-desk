...
assert(app.includes("paymentRepairCloseoutAudit") && app.includes("data-copy-payment-repair-closeout-audit"), "app.js is missing v540 Payment Repair Closeout Audit.");
