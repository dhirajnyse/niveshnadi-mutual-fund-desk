...
assert(app.includes("sourceCorrectionSupersedeQueue") && app.includes("data-copy-source-correction-supersede-queue"), "app.js is missing v534 Source Correction Supersede Queue.");
