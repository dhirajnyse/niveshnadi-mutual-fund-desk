...
assert(app.includes('value: "Static + visual pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Push pending"') && app.includes('value: "Local + visual passed"'), "app.js is missing the v651 responsive release receipt.");
assert(app.includes('{ version: "v646", key: "20260719-v646-01", commit: "09b18ff"') && app.includes('{ version: "v642", key: "20260719-v642-01", commit: "52b748f"') && !app.includes('{ version: "v641", key: "20260719-v641-01", commit: "e8a4643"'), "app.js release proof archive did not roll forward to v646-v642.");
