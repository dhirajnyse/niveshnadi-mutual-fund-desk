...
assert(app.includes('value: "Static + visual pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Live verification pending"'), "app.js is missing the v636 local visual verification receipt.");
