...
assert(app.includes("betaCommandArchiveAgingGuard") && app.includes("data-copy-beta-command-archive-aging-guard"), "app.js is missing v552 Beta Command Archive Aging Guard.");
