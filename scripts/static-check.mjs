...
assert(app.includes("accountRetentionStaleStateMonitor") && app.includes("data-copy-account-retention-stale-state-monitor"), "app.js is missing v536 Account Retention Stale-State Monitor.");
