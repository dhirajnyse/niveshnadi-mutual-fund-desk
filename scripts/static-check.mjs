...
assert(app.includes("betaCommandArchiveCompactor") && app.includes("data-copy-beta-command-archive-compactor"), "app.js is missing v547 Beta Command Archive Compactor.");
