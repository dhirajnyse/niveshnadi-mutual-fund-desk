...
assert(app.includes('value: "Static pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Live verified"') && app.includes('value: "Local + visual passed"'), "app.js is missing the v661 live release receipt.");
assert(app.includes('{ version: "v661", key: "20260719-v661-01", commit: "a5e49b9"') && app.includes('{ version: "v657", key: "20260719-v657-01", commit: "dd5afb2"') && !app.includes('{ version: "v656", key: "20260719-v656-01", commit: "deaafda"'), "app.js release proof archive did not roll forward to v661-v657.");
