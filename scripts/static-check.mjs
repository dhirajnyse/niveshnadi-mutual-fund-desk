...
assert(app.includes('value: "Static pass"') && app.includes('value: "Batch visual pending"') && app.includes('value: "Push pending"') && app.includes('value: "Local checks passed"'), "app.js is missing the v650 local release receipt.");
