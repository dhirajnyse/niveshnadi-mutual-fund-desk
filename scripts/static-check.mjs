...
assert(app.includes("supportRepairRecloseRenewalRefreshAgingGuard") && app.includes("data-copy-support-repair-reclose-renewal-refresh-aging-guard"), "app.js is missing v618 Support Repair Reclose Renewal Refresh Aging Guard.");
