...
assert(app.includes("paymentRecloseRenewalRefreshReopeningQueue") && app.includes("data-copy-payment-reclose-renewal-refresh-reopening-queue"), "app.js is missing v620 Payment Reclose Renewal Refresh Reopening Queue.");
