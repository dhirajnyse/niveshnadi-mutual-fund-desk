...
assert(app.includes('value: "Static pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Batch push pending"') && app.includes('value: "Local + visual passed"'), "app.js is missing the v656 local visual release receipt.");
assert(app.includes('{ version: "v651", key: "20260719-v651-01", commit: "7306980"') && app.includes('{ version: "v647", key: "20260719-v647-01", commit: "f8f689e"') && !app.includes('{ version: "v646", key: "20260719-v646-01", commit: "09b18ff"'), "app.js release proof archive did not roll forward to v651-v647.");
