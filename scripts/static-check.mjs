...
assert(app.includes("supportRepairRenewalCloseoutReceipt") && app.includes("data-copy-support-repair-renewal-closeout-receipt"), "app.js is missing v568 Support Repair Renewal Closeout Receipt.");
...
assert(app.includes("supportRepairCloseoutAgingGuard") && app.includes("data-copy-support-repair-closeout-aging-guard"), "app.js is missing v573 Support Repair Closeout Aging Guard.");
assert(app.includes("sourceCorrectionReopeningQueue") && app.includes("data-copy-source-correction-reopening-queue"), "app.js is missing v574 Source Correction Reopening Queue.");
assert(app.includes("paymentCloseoutReopeningQueue") && app.includes("data-copy-payment-closeout-reopening-queue"), "app.js is missing v575 Payment Closeout Reopening Queue.");
assert(app.includes("accountCloseoutReopeningQueue") && app.includes("data-copy-account-closeout-reopening-queue"), "app.js is missing v576 Account Closeout Reopening Queue.");
assert(app.includes("betaCommandReopeningQueue") && app.includes("data-copy-beta-command-reopening-queue"), "app.js is missing v577 Beta Command Reopening Queue.");
assert(app.includes("supportRepairReopeningQueue") && app.includes("data-copy-support-repair-reopening-queue"), "app.js is missing v578 Support Repair Reopening Queue.");
assert(app.includes("sourceCorrectionRecloseReceipt") && app.includes("data-copy-source-correction-reclose-receipt"), "app.js is missing v579 Source Correction Reclose Receipt.");
assert(app.includes("paymentRecloseReceipt") && app.includes("data-copy-payment-reclose-receipt"), "app.js is missing v580 Payment Reclose Receipt.");
assert(app.includes("accountRecloseReceipt") && app.includes("data-copy-account-reclose-receipt"), "app.js is missing v581 Account Reclose Receipt.");
assert(app.includes("betaCommandRecloseReceipt") && app.includes("data-copy-beta-command-reclose-receipt"), "app.js is missing v582 Beta Command Reclose Receipt.");
assert(app.includes("supportRepairRecloseReceipt") && app.includes("data-copy-support-repair-reclose-receipt"), "app.js is missing v583 Support Repair Reclose Receipt.");
assert(app.includes("sourceCorrectionRecloseAgingGuard") && app.includes("data-copy-source-correction-reclose-aging-guard"), "app.js is missing v584 Source Correction Reclose Aging Guard.");
assert(app.includes("paymentRecloseAgingGuard") && app.includes("data-copy-payment-reclose-aging-guard"), "app.js is missing v585 Payment Reclose Aging Guard.");
assert(app.includes("accountRecloseAgingGuard") && app.includes("data-copy-account-reclose-aging-guard"), "app.js is missing v586 Account Reclose Aging Guard.");
assert(app.includes("betaCommandRecloseAgingGuard") && app.includes("data-copy-beta-command-reclose-aging-guard"), "app.js is missing v587 Beta Command Reclose Aging Guard.");
assert(app.includes("supportRepairRecloseAgingGuard") && app.includes("data-copy-support-repair-reclose-aging-guard"), "app.js is missing v588 Support Repair Reclose Aging Guard.");
assert(app.includes("sourceCorrectionRecloseReopeningQueue") && app.includes("data-copy-source-correction-reclose-reopening-queue"), "app.js is missing v589 Source Correction Reclose Reopening Queue.");
assert(app.includes("paymentRecloseReopeningQueue") && app.includes("data-copy-payment-reclose-reopening-queue"), "app.js is missing v590 Payment Reclose Reopening Queue.");
assert(app.includes("accountRecloseReopeningQueue") && app.includes("data-copy-account-reclose-reopening-queue"), "app.js is missing v591 Account Reclose Reopening Queue.");
assert(app.includes("betaCommandRecloseReopeningQueue") && app.includes("data-copy-beta-command-reclose-reopening-queue"), "app.js is missing v592 Beta Command Reclose Reopening Queue.");
assert(app.includes("supportRepairRecloseReopeningQueue") && app.includes("data-copy-support-repair-reclose-reopening-queue"), "app.js is missing v593 Support Repair Reclose Reopening Queue.");
assert(app.includes("sourceCorrectionRecloseRenewalReceipt") && app.includes("data-copy-source-correction-reclose-renewal-receipt"), "app.js is missing v594 Source Correction Reclose Renewal Receipt.");
assert(app.includes("paymentRecloseRenewalReceipt") && app.includes("data-copy-payment-reclose-renewal-receipt"), "app.js is missing v595 Payment Reclose Renewal Receipt.");
assert(app.includes("accountRecloseRenewalReceipt") && app.includes("data-copy-account-reclose-renewal-receipt"), "app.js is missing v596 Account Reclose Renewal Receipt.");
assert(app.includes("betaCommandRecloseRenewalReceipt") && app.includes("data-copy-beta-command-reclose-renewal-receipt"), "app.js is missing v597 Beta Command Reclose Renewal Receipt.");
...
assert(app.includes("betaCommandRecloseRenewalAgingGuard") && app.includes("data-copy-beta-command-reclose-renewal-aging-guard"), "app.js is missing v602 Beta Command Reclose Renewal Aging Guard.");
assert(app.includes("supportRepairRecloseRenewalAgingGuard") && app.includes("data-copy-support-repair-reclose-renewal-aging-guard"), "app.js is missing v603 Support Repair Reclose Renewal Aging Guard.");
assert(app.includes("sourceCorrectionRecloseRenewalReopeningQueue") && app.includes("data-copy-source-correction-reclose-renewal-reopening-queue"), "app.js is missing v604 Source Correction Reclose Renewal Reopening Queue.");
assert(app.includes("paymentRecloseRenewalReopeningQueue") && app.includes("data-copy-payment-reclose-renewal-reopening-queue"), "app.js is missing v605 Payment Reclose Renewal Reopening Queue.");
assert(app.includes("accountRecloseRenewalReopeningQueue") && app.includes("data-copy-account-reclose-renewal-reopening-queue"), "app.js is missing v606 Account Reclose Renewal Reopening Queue.");
assert(app.includes("betaCommandRecloseRenewalReopeningQueue") && app.includes("data-copy-beta-command-reclose-renewal-reopening-queue"), "app.js is missing v607 Beta Command Reclose Renewal Reopening Queue.");
assert(app.includes("supportRepairRecloseRenewalReopeningQueue") && app.includes("data-copy-support-repair-reclose-renewal-reopening-queue"), "app.js is missing v608 Support Repair Reclose Renewal Reopening Queue.");
assert(app.includes("sourceCorrectionRecloseRenewalRefreshReceipt") && app.includes("data-copy-source-correction-reclose-renewal-refresh-receipt"), "app.js is missing v609 Source Correction Reclose Renewal Refresh Receipt.");
assert(app.includes("paymentRecloseRenewalRefreshReceipt") && app.includes("data-copy-payment-reclose-renewal-refresh-receipt"), "app.js is missing v610 Payment Reclose Renewal Refresh Receipt.");
assert(app.includes("accountRecloseRenewalRefreshReceipt") && app.includes("data-copy-account-reclose-renewal-refresh-receipt"), "app.js is missing v611 Account Reclose Renewal Refresh Receipt.");
assert(app.includes("betaCommandRecloseRenewalRefreshReceipt") && app.includes("data-copy-beta-command-reclose-renewal-refresh-receipt"), "app.js is missing v612 Beta Command Reclose Renewal Refresh Receipt.");
assert(app.includes("supportRepairRecloseRenewalRefreshReceipt") && app.includes("data-copy-support-repair-reclose-renewal-refresh-receipt"), "app.js is missing v613 Support Repair Reclose Renewal Refresh Receipt.");
assert(app.includes("sourceCorrectionRecloseRenewalRefreshAgingGuard") && app.includes("data-copy-source-correction-reclose-renewal-refresh-aging-guard"), "app.js is missing v614 Source Correction Reclose Renewal Refresh Aging Guard.");
assert(app.includes("paymentRecloseRenewalRefreshAgingGuard") && app.includes("data-copy-payment-reclose-renewal-refresh-aging-guard"), "app.js is missing v615 Payment Reclose Renewal Refresh Aging Guard.");
assert(app.includes("betaCommandRecloseRenewalRefreshReopeningQueue") && app.includes("data-copy-beta-command-reclose-renewal-refresh-reopening-queue"), "app.js is missing v622 Beta Command Reclose Renewal Refresh Reopening Queue.");
assert(app.includes("supportRepairRecloseRenewalRefreshReopeningQueue") && app.includes("data-copy-support-repair-reclose-renewal-refresh-reopening-queue"), "app.js is missing v623 Support Repair Reclose Renewal Refresh Reopening Queue.");
assert(app.includes("sourceCorrectionRecloseRenewalRefreshReacceptanceReceipt") && app.includes("data-copy-source-correction-reclose-renewal-refresh-reacceptance-receipt"), "app.js is missing v624 Source Correction Reclose Renewal Refresh Reacceptance Receipt.");
assert(app.includes("paymentRecloseRenewalRefreshReacceptanceReceipt") && app.includes("data-copy-payment-reclose-renewal-refresh-reacceptance-receipt"), "app.js is missing v625 Payment Reclose Renewal Refresh Reacceptance Receipt.");
assert(app.includes("accountRecloseRenewalRefreshReacceptanceReceipt") && app.includes("data-copy-account-reclose-renewal-refresh-reacceptance-receipt"), "app.js is missing v626 Account Reclose Renewal Refresh Reacceptance Receipt.");
assert(app.includes("betaCommandRecloseRenewalRefreshReacceptanceReceipt") && app.includes("data-copy-beta-command-reclose-renewal-refresh-reacceptance-receipt"), "app.js is missing v627 Beta Command Reclose Renewal Refresh Reacceptance Receipt.");
assert(app.includes("supportRepairRecloseRenewalRefreshReacceptanceReceipt") && app.includes("data-copy-support-repair-reclose-renewal-refresh-reacceptance-receipt"), "app.js is missing v628 Support Repair Reclose Renewal Refresh Reacceptance Receipt.");
...
assert(app.includes("sourceCorrectionRecloseRenewalRefreshReacceptanceReopeningQueue") && app.includes("data-copy-source-correction-reclose-renewal-refresh-reacceptance-reopening-queue"), "app.js is missing v634 Source Correction Reclose Renewal Refresh Reacceptance Reopening Queue.");
assert(app.includes("paymentRecloseRenewalRefreshReacceptanceReopeningQueue") && app.includes("data-copy-payment-reclose-renewal-refresh-reacceptance-reopening-queue"), "app.js is missing v635 Payment Reclose Renewal Refresh Reacceptance Reopening Queue.");
assert(app.includes("accountRecloseRenewalRefreshReacceptanceReopeningQueue") && app.includes("data-copy-account-reclose-renewal-refresh-reacceptance-reopening-queue"), "app.js is missing v636 Account Reclose Renewal Refresh Reacceptance Reopening Queue.");
assert(app.includes("betaCommandRecloseRenewalRefreshReacceptanceReopeningQueue") && app.includes("data-copy-beta-command-reclose-renewal-refresh-reacceptance-reopening-queue"), "app.js is missing v637 Beta Command Reclose Renewal Refresh Reacceptance Reopening Queue.");
assert(app.includes("supportRepairRecloseRenewalRefreshReacceptanceReopeningQueue") && app.includes("data-copy-support-repair-reclose-renewal-refresh-reacceptance-reopening-queue"), "app.js is missing v638 Support Repair Reclose Renewal Refresh Reacceptance Reopening Queue.");
assert(app.includes("sourceCorrectionRecloseRenewalRefreshRevalidationReceipt") && app.includes("data-copy-source-correction-reclose-renewal-refresh-revalidation-receipt"), "app.js is missing v639 Source Correction Reclose Renewal Refresh Revalidation Receipt.");
assert(app.includes("paymentRecloseRenewalRefreshRevalidationReceipt") && app.includes("data-copy-payment-reclose-renewal-refresh-revalidation-receipt"), "app.js is missing v640 Payment Reclose Renewal Refresh Revalidation Receipt.");
assert(app.includes("accountRecloseRenewalRefreshRevalidationReceipt") && app.includes("data-copy-account-reclose-renewal-refresh-revalidation-receipt"), "app.js is missing v641 Account Reclose Renewal Refresh Revalidation Receipt.");
assert(app.includes("betaCommandRecloseRenewalRefreshRevalidationReceipt") && app.includes("data-copy-beta-command-reclose-renewal-refresh-revalidation-receipt"), "app.js is missing v642 Beta Command Reclose Renewal Refresh Revalidation Receipt.");
assert(app.includes("supportRepairRecloseRenewalRefreshRevalidationReceipt") && app.includes("data-copy-support-repair-reclose-renewal-refresh-revalidation-receipt"), "app.js is missing v643 Support Repair Reclose Renewal Refresh Revalidation Receipt.");
assert(app.includes("sourceCorrectionRecloseRenewalRefreshRevalidationAgingGuard") && app.includes("data-copy-source-correction-reclose-renewal-refresh-revalidation-aging-guard"), "app.js is missing v644 Source Correction Reclose Renewal Refresh Revalidation Aging Guard.");
assert(app.includes("paymentRecloseRenewalRefreshRevalidationAgingGuard") && app.includes("data-copy-payment-reclose-renewal-refresh-revalidation-aging-guard"), "app.js is missing v645 Payment Reclose Renewal Refresh Revalidation Aging Guard.");
assert(app.includes("accountRecloseRenewalRefreshRevalidationAgingGuard") && app.includes("data-copy-account-reclose-renewal-refresh-revalidation-aging-guard"), "app.js is missing v646 Account Reclose Renewal Refresh Revalidation Aging Guard.");
assert(app.includes("betaCommandRecloseRenewalRefreshRevalidationAgingGuard") && app.includes("data-copy-beta-command-reclose-renewal-refresh-revalidation-aging-guard"), "app.js is missing v647 Beta Command Reclose Renewal Refresh Revalidation Aging Guard.");
assert(app.includes("supportRepairRecloseRenewalRefreshRevalidationAgingGuard") && app.includes("data-copy-support-repair-reclose-renewal-refresh-revalidation-aging-guard"), "app.js is missing v648 Support Repair Reclose Renewal Refresh Revalidation Aging Guard.");
assert(app.includes("sourceCorrectionRecloseRenewalRefreshRevalidationReopeningQueue") && app.includes("data-copy-source-correction-reclose-renewal-refresh-revalidation-reopening-queue"), "app.js is missing v649 Source Correction Reclose Renewal Refresh Revalidation Reopening Queue.");
assert(app.includes("paymentRecloseRenewalRefreshRevalidationReopeningQueue") && app.includes("data-copy-payment-reclose-renewal-refresh-revalidation-reopening-queue"), "app.js is missing v650 Payment Reclose Renewal Refresh Revalidation Reopening Queue.");
assert(app.includes("accountRecloseRenewalRefreshRevalidationReopeningQueue") && app.includes("data-copy-account-reclose-renewal-refresh-revalidation-reopening-queue"), "app.js is missing v651 Account Reclose Renewal Refresh Revalidation Reopening Queue.");
assert(app.includes("betaCommandRecloseRenewalRefreshRevalidationReopeningQueue") && app.includes("data-copy-beta-command-reclose-renewal-refresh-revalidation-reopening-queue"), "app.js is missing v652 Beta Command Reclose Renewal Refresh Revalidation Reopening Queue.");
assert(app.includes("supportRepairRecloseRenewalRefreshRevalidationReopeningQueue") && app.includes("data-copy-support-repair-reclose-renewal-refresh-revalidation-reopening-queue"), "app.js is missing v653 Support Repair Reclose Renewal Refresh Revalidation Reopening Queue.");
assert(app.includes("sourceCorrectionRecloseRenewalRefreshRevalidationRenewalReceipt") && app.includes("data-copy-source-correction-reclose-renewal-refresh-revalidation-renewal-receipt"), "app.js is missing v654 Source Correction Reclose Renewal Refresh Revalidation Renewal Receipt.");
assert(app.includes("paymentRecloseRenewalRefreshRevalidationRenewalReceipt") && app.includes("data-copy-payment-reclose-renewal-refresh-revalidation-renewal-receipt"), "app.js is missing v655 Payment Reclose Renewal Refresh Revalidation Renewal Receipt.");
assert(app.includes("accountRecloseRenewalRefreshRevalidationRenewalReceipt") && app.includes("data-copy-account-reclose-renewal-refresh-revalidation-renewal-receipt"), "app.js is missing v656 Account Reclose Renewal Refresh Revalidation Renewal Receipt.");
assert(app.includes("betaCommandRecloseRenewalRefreshRevalidationRenewalReceipt") && app.includes("data-copy-beta-command-reclose-renewal-refresh-revalidation-renewal-receipt"), "app.js is missing v657 Beta Command Reclose Renewal Refresh Revalidation Renewal Receipt.");
assert(app.includes("supportRepairRecloseRenewalRefreshRevalidationRenewalReceipt") && app.includes("data-copy-support-repair-reclose-renewal-refresh-revalidation-renewal-receipt"), "app.js is missing v658 Support Repair Reclose Renewal Refresh Revalidation Renewal Receipt.");
assert(app.includes("sourceCorrectionRecloseRenewalRefreshRevalidationRenewalAgingGuard") && app.includes("data-copy-source-correction-reclose-renewal-refresh-revalidation-renewal-aging-guard"), "app.js is missing v659 Source Correction Reclose Renewal Refresh Revalidation Renewal Aging Guard.");
assert(app.includes("paymentRecloseRenewalRefreshRevalidationRenewalAgingGuard") && app.includes("data-copy-payment-reclose-renewal-refresh-revalidation-renewal-aging-guard"), "app.js is missing v660 Payment Reclose Renewal Refresh Revalidation Renewal Aging Guard.");
assert(app.includes("accountRecloseRenewalRefreshRevalidationRenewalAgingGuard") && app.includes("data-copy-account-reclose-renewal-refresh-revalidation-renewal-aging-guard"), "app.js is missing v661 Account Reclose Renewal Refresh Revalidation Renewal Aging Guard.");
assert(app.includes('value: "Static pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Batch push pending"') && app.includes('value: "Local + visual passed"'), "app.js is missing the v661 responsive release receipt.");
assert(app.includes('{ version: "v656", key: "20260719-v656-01", commit: "deaafda"') && app.includes('{ version: "v652", key: "20260719-v652-01", commit: "c8f8348"') && !app.includes('{ version: "v651", key: "20260719-v651-01", commit: "7306980"'), "app.js release proof archive did not roll forward to v656-v652.");
