...
assert(app.includes("accountRecloseRenewalRefreshReopeningQueue") && app.includes("data-copy-account-reclose-renewal-refresh-reopening-queue"), "app.js is missing v621 Account Reclose Renewal Refresh Reopening Queue.");
