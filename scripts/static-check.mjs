...
assert(app.includes('value: "Static + visual pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Push pending"') && app.includes('value: "Local + visual passed"'), "app.js is missing the v646 responsive release receipt.");
assert(app.includes('{ version: "v641", key: "20260719-v641-01", commit: "e8a4643"') && app.includes('{ version: "v637", key: "20260719-v637-01", commit: "a69b2da"') && !app.includes('{ version: "v636", key: "20260719-v636-01", commit: "534f49b"'), "app.js release proof archive did not roll forward to v641-v637.");
