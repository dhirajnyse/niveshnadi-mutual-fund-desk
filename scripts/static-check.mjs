...
assert(app.includes("betaCommandRecloseRenewalRefreshAgingGuard") && app.includes("data-copy-beta-command-reclose-renewal-refresh-aging-guard"), "app.js is missing v617 Beta Command Reclose Renewal Refresh Aging Guard.");
