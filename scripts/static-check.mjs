...
assert(app.includes("sourceCorrectionRecloseRenewalRefreshReopeningQueue") && app.includes("data-copy-source-correction-reclose-renewal-refresh-reopening-queue"), "app.js is missing v619 Source Correction Reclose Renewal Refresh Reopening Queue.");
