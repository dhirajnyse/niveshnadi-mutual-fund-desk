...
assert(app.includes("sourceCorrectionExpiryGuard") && app.includes("data-copy-source-correction-expiry-guard"), "app.js is missing v549 Source Correction Expiry Guard.");
