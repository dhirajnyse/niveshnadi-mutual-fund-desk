...
assert(app.includes("betaFounderCloseoutScorecard") && app.includes("data-copy-beta-founder-closeout-scorecard"), "app.js is missing v522 Beta Founder Closeout Scorecard.");
