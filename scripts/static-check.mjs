...
assert(app.includes("sourceCorrectionArchiveCompactor") && app.includes("data-copy-source-correction-archive-compactor"), "app.js is missing v544 Source Correction Archive Compactor.");
