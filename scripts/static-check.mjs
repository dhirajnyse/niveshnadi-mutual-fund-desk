...
assert(app.includes('value: "Static pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Live verified"') && app.includes('value: "Local + visual passed"'), "app.js is missing the v656 live release receipt.");
