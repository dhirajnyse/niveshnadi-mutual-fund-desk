...
assert(app.includes("sourceCorrectionPublicChangelog") && app.includes("data-copy-source-correction-public-changelog"), "app.js is missing v529 Source Correction Public Changelog.");
