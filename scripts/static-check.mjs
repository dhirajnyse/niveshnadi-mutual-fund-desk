...
assert(app.includes("accountRecloseRenewalRefreshAgingGuard") && app.includes("data-copy-account-reclose-renewal-refresh-aging-guard"), "app.js is missing v616 Account Reclose Renewal Refresh Aging Guard.");
