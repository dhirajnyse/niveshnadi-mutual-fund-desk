...
assert(app.includes('value: "Static + visual pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Live verified"') && app.includes('value: "Local + visual passed"'), "app.js is missing the v651 verified release receipt.");
