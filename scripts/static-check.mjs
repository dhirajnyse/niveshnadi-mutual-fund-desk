...
assert(app.includes('value: "Static + visual pass"') && app.includes('value: "Responsive pass"') && app.includes('value: "Live verified"'), "app.js is missing the v636 live verification receipt.");
