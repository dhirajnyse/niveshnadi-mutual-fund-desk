...
assert(app.includes("sourceCorrectionRetirementMonitor") && app.includes("data-copy-source-correction-retirement-monitor"), "app.js is missing v539 Source Correction Retirement Monitor.");
